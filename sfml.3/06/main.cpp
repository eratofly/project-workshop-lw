...
void initEye(Eye &eye, sf::Vector2f position, sf::Vector2f mousePosition)
{
...
int main()
{
    ...
    initEye(leftEye, {300, WINDOW_HEIGHT / 2}, mousePosition);
    initEye(rightEye, {500, WINDOW_HEIGHT / 2}, mousePosition);
