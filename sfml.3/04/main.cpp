...
void updateArrowElements(Arrow &arrow)
{
    ...
    arrow.head.setRotation(toDegress(arrow.rotation));

    const sf::Vector2f steamOffset = toEuclidean(-10, arrow.rotation);
...
void initArrow(Arrow &arrow)
{
    ...
    arrow.stem.setFillColor(sf::Color(0xF0, 0xA0, 0));
